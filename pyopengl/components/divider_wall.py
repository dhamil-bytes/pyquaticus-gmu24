...
class Equator(GameObject):
    def __init__(self, width=10.0, depth=18.0, thickness=0.005):
        super().__init__()
        self.width = width
        self.depth = depth
        self.thickness = thickness
    ...
    def draw(self):
        ...
        glVertex3f(self.width/2, 0, -self.depth/2) 
        glVertex3f(self.width/2, self.thickness/2, -self.depth/2)
        glVertex3f(-self.width/2, self.thickness/2, -self.depth/2)
        ...
        # Top face
        glVertex3f(-self.width/2, self.thickness, -self.depth/2)
        glVertex3f(self.width/2, self.thickness, -self.depth/2)
        glVertex3f(self.width/2, self.thickness, self.depth/2)
        glVertex3f(-self.width/2, self.thickness, self.depth/2)
